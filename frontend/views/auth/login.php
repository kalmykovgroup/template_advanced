...
<div class="site-login">
    <div class="centerBlockForm">
        ...
        <div class="methodSelectionLogin">
            <a href="#" class="labelEmailOrLogin active"  data-btn="username"><span class="text">Email или Логин</span></a>
        ...
        <div class="blockFields">
                        ...
                        <?= $form->field($model, 'phone', [
                            ...
                            'options' => [ 'class' => 'pairUsernamePhone',
                                'style' => 'display:none'
                            ]
